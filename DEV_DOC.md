...
To build the project from the root, run `make`. This command creates the data directories for volumes and builds the Docker Compose in the srcs directory, then starts the containers. See [README](README.md) for all available Makefile commands.
